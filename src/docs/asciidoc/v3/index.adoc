...
the item in JSON format, the file itself, and an optional 'alternate' file that can be used
as the web-viewable rendition of the content item.

The metadata is the multipart item "document," the file is the multipart item "attachment," and
the alternate web-viewable file is the multipart item "alternate."
...
[[merge-to-pdf]]
=== Merge search result to PDF

A `POST` request to retrieve a pdf that contains all the documents from a search


==== Request structure

include::searchModelDoc.adoc[]
include::{snippets}/v3/merge-search-to-pdf/request-parameters.adoc[]
include::{snippets}/v3/merge-search-to-pdf/request-fields.adoc[]
include::{snippets}/v3/merge-search-to-pdf/http-request.adoc[]

==== Example request

include::{snippets}/v3/merge-search-to-pdf/curl-request.adoc[]

==== Example response

include::{snippets}/v3/merge-search-to-pdf/http-response.adoc[]